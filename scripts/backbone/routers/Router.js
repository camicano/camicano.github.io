...
app.Router = Backbone.Router.extend({
  ...
  initialize: function() {
    this.projects = new app.ProjectList([
      ...
      new app.Project({title: 'White Paradise', link: '#', image: 'images/white.png', description: 'A story about the relationship between the production of cocaine and the war in Colombia (This app is currently not live)', techspecs: [ 'Rails 4', 'Ruby', 'Mongo DB', 'JavaScript', 'D3' ], github: 'https://github.com/camicano/infographic' })
    ]);
